...
String serverName = "http://192.168.83.203:8080/";
HTTPClient http;
...
const char *MQTT_BROKER_ADRESS = "192.168.83.203";
const uint16_t MQTT_PORT = 1883;

// Name for this MQTT client
const char *MQTT_CLIENT_NAME = "ESP32-Yisus";
...
void setup()
{
  sprintf(topico, "Group_%d", GROUP_ID);
